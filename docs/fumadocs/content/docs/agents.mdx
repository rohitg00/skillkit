...
description: 44 AI coding agents supported by SkillKit
---

# Supported Agents

SkillKit uses an adapter pattern to support 44 AI coding platforms. Each adapter implements `getConfigPath()` and `generateConfig()` methods.
